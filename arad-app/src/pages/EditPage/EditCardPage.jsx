...
const EditCardPage = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://monkfish-app-z9uza.ondigitalocean.app/bcard2/cards/${_id}`) //Take this for the userProfileEdit and Use the userData.id instead of _id
      .then(({ data }) => {
        setDataFromServer(data);
        console.log(data, "This is my log for the Dataaaa");
        setInputValue({
          title: data.title,
